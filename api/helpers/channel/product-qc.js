module.exports = {
  ...
  fn: async function (inputs,exits) {
    ...
    let sign = integration.channel.name === 'dafiti' ? await sails.helpers.channel.dafiti.sign(integration.id, 'GetQcStatus', integration.seller, ['SkuSellerList='+JSON.stringify(sellerSkus)]) :
    await sails.helpers.channel.linio.sign(integration.id, 'GetQcStatus', integration.seller, ['SkuSellerList='+JSON.stringify(sellerSkus)]);
