module.exports = {
  ...
  description: 'Para recibir el estado de un feed en linio mexico.',
  inputs: {
    integration: {
      type:'ref',
      required:true,
  ...
  fn: async function (inputs,exits) {
    ...
    let sign = await sails.helpers.channel.liniomx.sign(integration.id, 'FeedStatus', integration.seller, ['FeedID='+inputs.feed]);
