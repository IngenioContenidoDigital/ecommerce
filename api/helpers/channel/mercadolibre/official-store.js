module.exports = {
  ...
  fn: async function (inputs,exits) {
    try{
      let response = await sails.helpers.channel.mercadolibre.request('users/'+inputs.integration.useridml+'/brands', inputs.integration.channel.endpoint, inputs.integration.secret);
