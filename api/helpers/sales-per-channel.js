module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    const rteIcaCC = inputs.dateStart < moment('01-09-2021', 'DD-MM-YYYY').valueOf() ? (totalCc * 0.00414) : 0;
    let rteTc = (totalCc * 0.015) + (rteIca * 0.15) + rteIcaCC;
