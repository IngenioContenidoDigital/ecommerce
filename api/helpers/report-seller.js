module.exports = {
  ...
  fn: async function (inputs, exits) {
    ...
    let resultRetFte = totalSku !== 0 && totalCommission === 0 ? totalRetFte + (totalSku >= 145000 ? (totalOtherConcepts/1.19)*retFte : 0) : totalSku !== 0 ? totalRetFte + (totalOtherConcepts/1.19)*retFte : totalRetFte;
    totalRetIca = totalSku !== 0  && address.city.name === 'bogota' ? totalRetIca + (totalSku >= 145000 ? (totalOtherConcepts/1.19)*(retIca/1000) : 0) : totalRetIca;
