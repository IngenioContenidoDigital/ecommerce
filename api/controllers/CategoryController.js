  ...
  categoryscheme: async (req,res) =>{
    ...
    let aliases = {
      groups: [
        ...
        ["catre","cama"],
        ["conjunto deportivo","sudadera","pantalón sudadera","sudaderas"],
        ["chaqueta","chammara"],
        ["cinturón","correa"],
        ["abrigo","abrigos"],
