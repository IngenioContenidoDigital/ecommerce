...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'GET /c/:route' : {controller:'IndexController',action:'cms'},
  'GET /cms/:action?/:id?' : {controller:'SellerController',action:'cms'},
  'POST /cms/:action/:id?' : {controller:'SellerController',action:'cmsexecute'},
