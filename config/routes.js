...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'GET /reportseller/:seller': {controller:'IndexController', action:'generateReportSeller'},
  ...
  'GET /dafiticheck/:seller?' : {controller:'ProductController',action:'dafiticheck'},
  'GET /liniocheck/:seller?' : {controller:'ProductController',action:'liniocheck'},
