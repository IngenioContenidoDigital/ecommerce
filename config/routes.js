...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'GET /registerseller' : { controller:'SellerController',action:'registerformseller' },
  'POST /registerseller' : {controller:'SellerController',action:'createsellerfromform'},
  'GET /sellerform/:token?' : { controller:'SellerController',action:'sellerform' },
  ...
  'POST /seller/createfromtoken' : {controller:'SellerController',action:'createsellerfromtoken'},
  ...
  'GET /catalogquery/:page?' : {controller:'ProductController',action:'findcatalog'},
