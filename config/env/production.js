...
module.exports = {
  ...
  ***************************************************************************/
  session: {
    ...
    ***************************************************************************/
    ...
    //--------------------------------------------------------------------------
    adapter: '@sailshq/connect-redis',
    //url: 'redis://:Y0tr.u21*@localhost:6379/7',
    url: 'redis://redis-test.zhjimc.ng.0001.use1.cache.amazonaws.com:6379/7',
  ...
  sockets: {
    ...
    ***************************************************************************/
    onlyAllowOrigins: [
      'http://localhost:1337',
      'http://iridio.co:1337',
      'https://iridio.co:1337',
      'https://iridio.co',
      'https://1ecommerce.app',
      'https://1ecommerce.app:1337',
      'https://www.1ecommerce.app',
      'https://www.iridio.co',
      'https://www.sanpolos.com',
      'https://sanpolos.com'
    ],
  ...
  **************************************************************************/
  //ssl: undefined,
  //ssl: {
    //ca: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/chain1.pem')),
    //key: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/privkey1.pem')),
    //cert: require('fs').readFileSync(require('path').resolve(__dirname,'../ssl/cert1.pem'))
  //},
